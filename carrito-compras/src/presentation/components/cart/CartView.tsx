...
/**
 * Componente principal de la vista del carrito que muestra los productos añadidos, permite modificar cantidades, eliminar productos y muestra un resumen del pedido.
 *
 * Responsabilidad:
 * - Mostrar los productos añadidos al carrito.
 * - Permitir modificar la cantidad de cada producto.
 * - Eliminar productos del carrito.
 * - Mostrar un resumen del pedido con subtotal, envío y total.
 * 
 * Contexto de Negocio:
 * - Si el carrito está vacío, se muestra un mensaje invitando a explorar productos.
 * - Se calcula el precio total considerando descuentos aplicables.
 * - El envío es gratuito para pedidos superiores a 100€.
 * 
 * Dependencias:
 * - useCart: Hook para acceder al estado y acciones del carrito.
 * - Link: Componente de navegación para redirigir a la página de productos o carrito.
 */
