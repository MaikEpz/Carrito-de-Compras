...
import { mockProducts, searchProducts } from '@/lib/products';
    ...
    <section className="py-5 sm:py-20" >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl font-bold text-foreground sm:text-5xl lg:text-6xl bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
