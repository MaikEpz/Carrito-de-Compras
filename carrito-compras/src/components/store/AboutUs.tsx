        ...
        <section className="py-24 px-6 bg-background border-b border-border" id="AboutUs">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <img alt="Detalle de madera tallada" className="w-full h-80 object-cover mt-12" src="https://cdn.pixabay.com/photo/2018/06/14/21/15/bedroom-3475656_1280.jpg" />
                    <img alt="Lámpara de diseño minimalista" className="w-full h-80 object-cover" src="https://cdn.pixabay.com/photo/2014/09/15/21/46/couch-447484_1280.jpg" />
                </div>
            </div>
        </section>
    )
