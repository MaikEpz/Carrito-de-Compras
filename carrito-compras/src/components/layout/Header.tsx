  ...
  return (
    ...
    <header className="sticky top-0 z-50 w-full border-b border-black/8 bg-background backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/*Search Bar - Desktop */}
        <form onSubmit={handleSearch} className="hidden flex-1 max-w-lg mx-8 md:flex bg-black/5 rounded-lg">
      ...
      {mobileMenuOpen && (
        <div className="border-t border-border bg-background md:hidden">
          <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6">
            {/* Mobile Search */}
            <form onSubmit={handleSearch} className="mb-4 bg-black/5 rounded-lg">
