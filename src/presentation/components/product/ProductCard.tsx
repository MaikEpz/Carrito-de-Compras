...
/**
 * Componente de Tarjeta de Producto que representa visualmente un producto en el catálogo y permite al usuario interactuar con él (agregar al carrito, ver detalles).
 *
 * Responsabilidad:
 * - Mostrar información básica del producto (imagen, nombre, categoría, precio).
 * - Permitir al usuario agregar el producto al carrito.
 ...
 * - El botón de agregar al carrito es accesible y fácil de usar, incentivando la compra.
 * 
 * Dependencias:
 ...
 * - CartIcon: Icono para el botón de agregar al carrito.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`p-4 ${
            viewMode === 'list' ? 'flex flex-col justify-between flex-1' : ''
          }`}
        >
          <div>
