...
/**
 * Componente de la barra lateral del carrito que muestra los productos añadidos, permite modificar cantidades y eliminar productos.
 *
 * Responsabilidad:
 ...
 * - TrashIcon, MinusIcon, PlusIcon: Iconos para las acciones de eliminar y modificar cantidades.
